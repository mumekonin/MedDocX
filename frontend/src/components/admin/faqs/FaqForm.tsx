      ...
      <div className="relative bg-[#0d0d14] border border-white/10 rounded-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto">
        ...
        <div className="p-7">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="block text-gray-400 text-xs font-medium mb-1.5">Question</label>
              <input
                {...register("question")}
            ...
            <div>
              <label className="block text-gray-400 text-xs font-medium mb-1.5">Answer</label>
              <textarea
                {...register("answer")}
                rows={4}
