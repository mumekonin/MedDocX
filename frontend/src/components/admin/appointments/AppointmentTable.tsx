  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Review and manage patient booking requests.</p>
      </div>
      ...
      {isLoading && <p className="text-gray-500 text-sm">Loading appointments...</p>}
      {isError && <p className="text-red-400 text-sm">Couldn't load appointments right now.</p>}
      {appointments && appointments.length === 0 && (
        <p className="text-gray-500 text-sm">No appointments found for this filter.</p>
      )}
          ...
          {appointments.map((appt) => (
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                {appt.reason && (
                  <p className="text-gray-500 text-xs mt-2 italic">"{appt.reason}"</p>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-red-500/10 flex items-center justify-center text-gray-400 hover:text-red-400 transition-colors shrink-0"
                  aria-label="Delete"
                >
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          <div className="relative bg-[#0d0d14] border border-white/10 rounded-2xl w-full max-w-sm p-6">
            <h3 className="text-white font-bold mb-2">Delete Appointment</h3>
