  ...
  return (
    <div>
      ...
      <main className="pt-[72px] bg-[#0a0a0f] min-h-screen">
        {isLoading && (
          <p className="text-gray-500 text-sm text-center py-24">Loading service...</p>
        )}
          ...
          <>
            ...
            <section className="relative px-6 pt-14 pb-20 overflow-hidden">
              ...
              <div className="max-w-4xl mx-auto relative z-10 text-center">
                ...
                <p className="text-gray-400 text-sm md:text-base max-w-xl mx-auto mt-5 leading-relaxed">
            ...
            <section className="px-6 pb-20">
              <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-10">
                <div className="md:col-span-2">
                  <h2 className="text-white font-bold text-xl mb-4">Overview</h2>
                  <p className="text-gray-400 leading-relaxed">{service.fullDescription}</p>
                </div>

                <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 h-fit">
                    ...
                    {relatedServices.map((related) => {
                      ...
                      return (
                        <Link
                          ...
                          className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:border-indigo-500/40 transition-colors group"
                        >
